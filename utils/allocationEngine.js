...
/**
 * Get max liters for vehicle type.
 */
...
export function runAllocationEngine(vehicles, cycle) {
  ...
  // Convert weights to budget per tier
  ...
  const summary = {
    ...
    fuelAllocated: assignments.reduce((sum, a) => sum + a.fuelLiters, 0),
    tierBreakdown: {
